...
public class Maze extends JPanel implements KeyListener
{
	...
	/**
	 * Toggles the "Maze Light Switch" on or off.
	 * @param b: Sets the light switch to on or off.
	 */
	...
	/**
	 * Sets the amplitude for the light reach.	
	 * @param value: Light radius amplitude of the light.
	 */
	public void setLightAmp(int value) {lightAmp = value;}
	
	/**
	 * Calculates the visible area surrounding the MazeRunner and paints the scenery accordingly. 
	 * @param p: Graphics2D.
	 */
